$(function () {
    $("#book-player").after('<div class="speed-controller"><input type="button" class="tool" id="minus-btn" value="-"><span id="x-str">x</span><input type="number" id="speed-num" value="1" step="0.01" max="10" min="0.1"><input type="button" class="tool" id="plus-btn" value="+"></div>');
